...
1. [Overview](#overview)
2. [How Perks Work](#how-perks-work)
3. [Perk Commands](#perk-commands)
4. [Deity Perk Trees](#deity-perk-trees)
...
Perks are permanent passive bonuses that enhance your character and religion. Each of the 8 deities has a unique perk tree with 10 perks:

- **6 Player Perks** - Personal bonuses that only affect you
- **4 Religion Perks** - Congregation-wide bonuses that affect all members

### Perk Structure

**Player Perks (6 total per deity):**
- **Tier 1 (Initiate):** 1 foundational perk - Available at 0 favor
- **Tier 2 (Disciple):** 2 path perks - Choose your playstyle at 500 favor
- **Tier 3 (Zealot):** 2 specialization perks - Double down at 2,000 favor
- **Tier 4 (Champion):** 1 capstone perk - Ultimate power at 5,000 favor (requires both Tier 3)

**Religion Perks (4 total per deity):**
...
✨ **Synergistic Capstones** - Tier 4 requires both Tier 3 perks, rewarding full investment
✨ **Unique Identities** - Each deity has distinct themes and playstyles
✨ **Additive Stacking** - Player and religion perks stack together
✨ **Permanent Power** - Perks persist forever once unlocked
...
4. Unlock prerequisite perks first (Tier 2+ have prerequisites)
5. Use `/perks unlock <perk_id>` to unlock

**Religion Perks:**
1. Your religion must reach required prestige rank
2. Only the religion founder can unlock religion perks
3. Prestige is earned collectively by all members through PvP
4. Use `/perks unlock <perk_id>` as founder

### Favor Ranks (Player Progression)

| Rank | Total Favor Required | Perks Available |
|------|---------------------|-----------------|
| **Initiate** | 0 | Tier 1 |
| **Disciple** | 500 | Tier 2 |
| **Zealot** | 2,000 | Tier 3 |
...
| Rank | Total Prestige Required | Perks Available |
|------|------------------------|-----------------|
| **Fledgling** | 0 | Tier 1 |
...
- Player perks stack additively with each other
- Religion perks stack additively with each other
- Player + religion perks combine for total bonus
- Example: Player +15% damage + Religion +10% damage = +25% total damage

**Special Effects:**
- Some perks grant special abilities (lifesteal, critical hits, stealth, etc.)
- Special effects are noted in perk descriptions
...
```bash
# List all available perks for your deity
/perks list

# View your unlocked player perks
/perks player

# View your religion's unlocked perks
/perks religion

# View details about a specific perk
/perks info <perk_id>

# View your deity's perk tree
/perks tree player
/perks tree religion

# View all active perks affecting you
/perks active
```
...
```bash
# Unlock a player perk (if you meet requirements)
/perks unlock <perk_id>

# Unlock a religion perk (founder only, if religion meets requirements)
/perks unlock <perk_id>
```
...
- ✅ Have unlocked all prerequisite perks
- ✅ Not already have the perk unlocked
...
### Typical Perk Unlock Path

**Early Game (0-500 favor):**
1. Join a religion serving your chosen deity
2. Unlock Tier 1 player perk (foundational bonus)
3. Help religion unlock Tier 1 religion perk (group bonus)
4. Earn 500 favor through PvP combat

**Mid Game (500-2,000 favor):**
1. Decide on your path (offense vs defense vs utility)
2. Unlock Tier 2 player perk matching your playstyle
3. Help religion reach 500 prestige for Tier 2 religion perk
4. Earn 2,000 favor for Tier 3 access

**Late Game (2,000-5,000 favor):**
1. Unlock Tier 3 specialization perk (doubling down on your path)
2. Consider unlocking the OTHER Tier 2 path as well (for capstone later)
3. Unlock other Tier 3 specialization perk
4. Help religion reach 5,000 prestige for Tier 4 religion perk
5. Earn 5,000 favor for Champion rank

**End Game (5,000+ favor):**
1. Unlock Tier 4 capstone perk (requires BOTH Tier 3 perks)
2. Enjoy maximum power with all 6 player + 4 religion perks
...
**Sniper Build:**
- Deadly Precision → Master Huntress → (unlock mobility perks for capstone) → Avatar of Hunt
- Maximum burst damage with crits, headshot hunter

**Speed Demon Build:**
- Silent Stalker → Apex Predator → (unlock precision perks for capstone) → Avatar of Hunt
...
**Lifesteal Vampire:**
- Soul Reaper → Plague Bearer → (unlock tank perks for capstone) → Lord of Death
- Sustain through lifesteal, spread poison, outlast everyone

**Unkillable Tank:**
- Undying → Deathless → (unlock lifesteal perks for capstone) → Lord of Death
...
**Q: Can I respec perks?**
A: No, perks are permanent once unlocked. Choose carefully!

**Q: What happens if I switch religions?**
A: You lose all perks and start over with a 7-day cooldown on switching.

**Q: Can I unlock perks for multiple deities?**
A: No, you can only unlock perks for your current religion's deity.

**Q: Do religion perks affect offline members?**
A: Yes, when they log in they get the buffs immediately.

**Q: Can I unlock all perks?**
A: Yes! You can unlock all 6 player + 4 religion perks (10 total).

**Q: What if my religion founder leaves?**
A: Founder transfers to next oldest member automatically.

**Q: Do perks stack with equipment bonuses?**
A: Yes, perks apply before equipment calculations.
