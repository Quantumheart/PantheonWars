...
namespace PantheonWars.Tests.Network
{
    ...
    public class ReligionListResponsePacketTests
    {
        ...
        public void ParameterizedConstructor_SetsProperties()
        {
            ...
            var packet = new ReligionListResponsePacket(new List<ReligionListResponsePacket.ReligionInfo> { religion1, religion2 });
        ...
        public void Serialize_Deserialize_ValuesArePreserved()
        {
            ...
            ms.Position = 0;
            var deserialized = ProtoBuf.Serializer.Deserialize<ReligionListResponsePacket>(ms);
