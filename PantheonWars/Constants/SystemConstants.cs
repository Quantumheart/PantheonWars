namespace PantheonWars.Constants
{
    ...
    public static class SystemConstants
    {
        ...
        /// <summary>
        /// Success message format for refreshing religion perks. Use with string.Format(SuccessRefreshedReligionPerks, religionName, memberCount)
        /// </summary>
        public const string SuccessRefreshedReligionPerksFormat = "Refreshed perks for religion {0} ({1} members)";

        /// <summary>
        /// Success message format for health update. Use with string.Format(SuccessHealthUpdate, playerName, beforeHealth, afterHealth, baseHealth, statValue)
        /// </summary>
