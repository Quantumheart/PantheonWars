...
public static class PerkDefinitions
{
    ...
    private static List<Perk> GetKhorasPerks()
    {
        return new List<Perk>
        {
            ...
            new(PerkIds.KhorasWarriorsResolve, "Warrior's Resolve", DeityType.Khoras)
            {
            ...
            new(PerkIds.KhorasBloodlust, "Bloodlust", DeityType.Khoras)
            {
                Kind = PerkKind.Player,
                Category = PerkCategory.Combat,
                Description =
            ...
            new(PerkIds.KhorasIronSkin, "Iron Skin", DeityType.Khoras)
            {
                Kind = PerkKind.Player,
            ...
            new(PerkIds.KhorasBerserkerRage, "Berserker Rage", DeityType.Khoras)
            {
                Kind = PerkKind.Player,
                Category = PerkCategory.Combat,
                Description =
            ...
            new(PerkIds.KhorasUnbreakable, "Unbreakable", DeityType.Khoras)
            {
                Kind = PerkKind.Player,
                Category = PerkCategory.Defense,
                Description =
            ...
            new(PerkIds.KhorasAvatarOfWar, "Avatar of War", DeityType.Khoras)
            {
                Kind = PerkKind.Player,
                Category = PerkCategory.Combat,
                Description =
            ...
            new(PerkIds.KhorasWarBanner, "War Banner", DeityType.Khoras)
            {
            ...
            new(PerkIds.KhorasLegionTactics, "Legion Tactics", DeityType.Khoras)
            {
                Kind = PerkKind.Religion,
                Category = PerkCategory.Combat,
                Description =
            ...
            new(PerkIds.KhorasWarhost, "Warhost", DeityType.Khoras)
            {
                Kind = PerkKind.Religion,
                Category = PerkCategory.Combat,
                Description =
            ...
            new(PerkIds.KhorasPantheonOfWar, "Pantheon of War", DeityType.Khoras)
            {
                Kind = PerkKind.Religion,
                Category = PerkCategory.Combat,
                Description =
    ...
    private static List<Perk> GetLysaPerks()
    {
        return new List<Perk>
        {
            ...
            // Tier 1 - Initiate (0-499 favor) - Foundation
            new(PerkIds.LysaKeenEye, "Keen Eye", DeityType.Lysa)
            {
                Kind = PerkKind.Player,
                Category = PerkCategory.Combat,
            ...
            // Tier 2 - Disciple (500-1999 favor) - Choose Your Path
            new(PerkIds.LysaDeadlyPrecision, "Deadly Precision", DeityType.Lysa)
            {
                Kind = PerkKind.Player,
                Category = PerkCategory.Combat,
                Description =
            ...
            new(PerkIds.LysaSilentStalker, "Silent Stalker", DeityType.Lysa)
            {
                Kind = PerkKind.Player,
            ...
            // Tier 3 - Zealot (2000-4999 favor) - Specialization
            new(PerkIds.LysaMasterHuntress, "Master Huntress", DeityType.Lysa)
            {
                Kind = PerkKind.Player,
                Category = PerkCategory.Combat,
                Description =
            ...
            new(PerkIds.LysaApexPredator, "Apex Predator", DeityType.Lysa)
            {
                Kind = PerkKind.Player,
                Category = PerkCategory.Mobility,
                Description =
            ...
            // Tier 4 - Champion (5000-9999 favor) - Capstone (requires both paths)
            new(PerkIds.LysaAvatarOfHunt, "Avatar of the Hunt", DeityType.Lysa)
            {
                Kind = PerkKind.Player,
                Category = PerkCategory.Combat,
                Description =
            ...
            // Tier 1 - Fledgling (0-499 prestige) - Foundation
            new(PerkIds.LysaPackHunters, "Pack Hunters", DeityType.Lysa)
            {
                Kind = PerkKind.Religion,
                Category = PerkCategory.Combat,
            ...
            // Tier 2 - Established (500-1999 prestige) - Coordination
            new(PerkIds.LysaCoordinatedStrike, "Coordinated Strike", DeityType.Lysa)
            {
                Kind = PerkKind.Religion,
                Category = PerkCategory.Combat,
                Description =
            ...
            new(PerkIds.LysaApexPack, "Apex Pack", DeityType.Lysa)
            {
                Kind = PerkKind.Religion,
                Category = PerkCategory.Combat,
                Description =
            ...
            new(PerkIds.LysaHuntersParadise, "Hunter's Paradise", DeityType.Lysa)
            {
                Kind = PerkKind.Religion,
                Category = PerkCategory.Combat,
                Description =
    ...
    private static List<Perk> GetMorthenPerks()
    {
        return new List<Perk>
        {
            ...
            // Tier 1 - Initiate (0-499 favor) - Foundation
            new(PerkIds.MorthenDeathsEmbrace, "Death's Embrace", DeityType.Morthen)
            {
                Kind = PerkKind.Player,
                Category = PerkCategory.Combat,
                Description =
            ...
            // Tier 2 - Disciple (500-1999 favor) - Choose Your Path
            new(PerkIds.MorthenSoulReaper, "Soul Reaper", DeityType.Morthen)
            {
                Kind = PerkKind.Player,
                Category = PerkCategory.Combat,
                Description =
            ...
            new(PerkIds.MorthenUndying, "Undying", DeityType.Morthen)
            {
                Kind = PerkKind.Player,
                Category = PerkCategory.Defense,
                Description =
            ...
            // Tier 3 - Zealot (2000-4999 favor) - Specialization
            new(PerkIds.MorthenPlagueBearer, "Plague Bearer", DeityType.Morthen)
            {
                Kind = PerkKind.Player,
                Category = PerkCategory.Combat,
                Description =
            ...
            new(PerkIds.MorthenDeathless, "Deathless", DeityType.Morthen)
            {
                Kind = PerkKind.Player,
                Category = PerkCategory.Defense,
                Description =
            ...
            // Tier 4 - Champion (5000-9999 favor) - Capstone (requires both paths)
            new(PerkIds.MorthenLordOfDeath, "Lord of Death", DeityType.Morthen)
            {
                Kind = PerkKind.Player,
                Category = PerkCategory.Combat,
                Description =
            ...
            // Tier 1 - Fledgling (0-499 prestige) - Foundation
            new(PerkIds.MorthenDeathCult, "Death Cult", DeityType.Morthen)
            {
                Kind = PerkKind.Religion,
                Category = PerkCategory.Combat,
                Description =
            ...
            // Tier 2 - Established (500-1999 prestige) - Coordination
            new(PerkIds.MorthenNecromanticCovenant, "Necromantic Covenant", DeityType.Morthen)
            {
                Kind = PerkKind.Religion,
                Category = PerkCategory.Combat,
                Description =
            ...
            // Tier 3 - Renowned (2000-4999 prestige) - Elite Force
            new(PerkIds.MorthenDeathlessLegion, "Deathless Legion", DeityType.Morthen)
            {
                Kind = PerkKind.Religion,
                Category = PerkCategory.Combat,
                Description =
            ...
            new(PerkIds.MorthenEmpireOfDeath, "Empire of Death", DeityType.Morthen)
            {
                Kind = PerkKind.Religion,
                Category = PerkCategory.Combat,
                Description =
    ...
    private static List<Perk> GetAethraPerks()
    {
        return new List<Perk>
        {
            ...
            // Tier 1 - Initiate (0-499 favor) - Foundation
            new(PerkIds.AethraDivineGrace, "Divine Grace", DeityType.Aethra)
            {
                Kind = PerkKind.Player,
            ...
            // Tier 2 - Disciple (500-1999 favor) - Choose Your Path
            new(PerkIds.AethraRadiantStrike, "Radiant Strike", DeityType.Aethra)
            {
                Kind = PerkKind.Player,
                Category = PerkCategory.Combat,
                Description =
            ...
            new(PerkIds.AethraBlessedShield, "Blessed Shield", DeityType.Aethra)
            {
                Kind = PerkKind.Player,
                Category = PerkCategory.Defense,
                Description =
            ...
            // Tier 3 - Zealot (2000-4999 favor) - Specialization
            new(PerkIds.AethraPurifyingLight, "Purifying Light", DeityType.Aethra)
            {
                Kind = PerkKind.Player,
                Category = PerkCategory.Combat,
                Description =
            ...
            new(PerkIds.AethraAegisOfLight, "Aegis of Light", DeityType.Aethra)
            {
                Kind = PerkKind.Player,
                Category = PerkCategory.Defense,
                Description =
            ...
            // Tier 4 - Champion (5000-9999 favor) - Capstone (requires both paths)
            new(PerkIds.AethraAvatarOfLight, "Avatar of Light", DeityType.Aethra)
            {
                Kind = PerkKind.Player,
                Category = PerkCategory.Combat,
                Description =
            ...
            // Tier 1 - Fledgling (0-499 prestige) - Foundation
            new(PerkIds.AethraBlessingOfLight, "Blessing of Light", DeityType.Aethra)
            {
                Kind = PerkKind.Religion,
                Category = PerkCategory.Utility,
                Description =
            ...
            // Tier 2 - Established (500-1999 prestige) - Coordination
            new(PerkIds.AethraDivineSanctuary, "Divine Sanctuary", DeityType.Aethra)
            {
                Kind = PerkKind.Religion,
                Category = PerkCategory.Defense,
                Description =
            ...
            // Tier 3 - Renowned (2000-4999 prestige) - Elite Force
            new(PerkIds.AethraSacredBond, "Sacred Bond", DeityType.Aethra)
            {
                Kind = PerkKind.Religion,
                Category = PerkCategory.Combat,
                Description =
            ...
            new(PerkIds.AethraCathedralOfLight, "Cathedral of Light", DeityType.Aethra)
            {
                Kind = PerkKind.Religion,
                Category = PerkCategory.Combat,
                Description =
    ...
    private static List<Perk> GetUmbrosPerks()
    {
        return new List<Perk>
        {
            ...
            // Tier 1 - Initiate (0-499 favor) - Foundation
            new(PerkIds.UmbrosShadowBlend, "Shadow Blend", DeityType.Umbros)
            {
                Kind = PerkKind.Player,
                Category = PerkCategory.Mobility,
                Description =
            ...
            // Tier 2 - Disciple (500-1999 favor) - Choose Your Path
            new(PerkIds.UmbrosAssassinate, "Assassinate", DeityType.Umbros)
            {
                Kind = PerkKind.Player,
                Category = PerkCategory.Combat,
                Description =
            ...
            new(PerkIds.UmbrosPhantomDodge, "Phantom Dodge", DeityType.Umbros)
            {
                Kind = PerkKind.Player,
                Category = PerkCategory.Mobility,
                Description =
            ...
            // Tier 3 - Zealot (2000-4999 favor) - Specialization
            new(PerkIds.UmbrosDeadlyAmbush, "Deadly Ambush", DeityType.Umbros)
            {
                Kind = PerkKind.Player,
                Category = PerkCategory.Combat,
                Description =
            ...
            new(PerkIds.UmbrosVanish, "Vanish", DeityType.Umbros)
            {
                Kind = PerkKind.Player,
                Category = PerkCategory.Mobility,
                Description =
            ...
            // Tier 4 - Champion (5000-9999 favor) - Capstone (requires both paths)
            new(PerkIds.UmbrosAvatarOfShadows, "Avatar of Shadows", DeityType.Umbros)
            {
                Kind = PerkKind.Player,
                Category = PerkCategory.Combat,
                Description =
            ...
            // Tier 1 - Fledgling (0-499 prestige) - Foundation
            new(PerkIds.UmbrosShadowCult, "Shadow Cult", DeityType.Umbros)
            {
                Kind = PerkKind.Religion,
                Category = PerkCategory.Mobility,
                Description =
            ...
            // Tier 2 - Established (500-1999 prestige) - Coordination
            new(PerkIds.UmbrosCloak, "Cloak of Shadows", DeityType.Umbros)
            {
                Kind = PerkKind.Religion,
                Category = PerkCategory.Combat,
                Description =
            ...
            new(PerkIds.UmbrosNightAssassins, "Night Assassins", DeityType.Umbros)
            {
                Kind = PerkKind.Religion,
                Category = PerkCategory.Combat,
                Description =
            ...
            new(PerkIds.UmbrosEternalDarkness, "Eternal Darkness", DeityType.Umbros)
            {
                Kind = PerkKind.Religion,
                Category = PerkCategory.Combat,
                Description =
    ...
    private static List<Perk> GetTharosPerks()
    {
        return new List<Perk>
        {
            ...
            // Tier 1 - Initiate (0-499 favor) - Foundation
            new(PerkIds.TharosStormborn, "Stormborn", DeityType.Tharos)
            {
                Kind = PerkKind.Player,
                Category = PerkCategory.Combat,
            ...
            // Tier 2 - Disciple (500-1999 favor) - Choose Your Path
            new(PerkIds.TharosLightningStrike, "Lightning Strike", DeityType.Tharos)
            {
                Kind = PerkKind.Player,
                Category = PerkCategory.Combat,
                Description =
            ...
            new(PerkIds.TharosStormRider, "Storm Rider", DeityType.Tharos)
            {
                Kind = PerkKind.Player,
                Category = PerkCategory.Mobility,
                Description =
            ...
            // Tier 3 - Zealot (2000-4999 favor) - Specialization
            new(PerkIds.TharosThunderlord, "Thunderlord", DeityType.Tharos)
            {
                Kind = PerkKind.Player,
                Category = PerkCategory.Combat,
                Description =
            ...
            new(PerkIds.TharosTempest, "Tempest", DeityType.Tharos)
            {
                Kind = PerkKind.Player,
                Category = PerkCategory.Mobility,
                Description =
            ...
            // Tier 4 - Champion (5000-9999 favor) - Capstone (requires both paths)
            new(PerkIds.TharosAvatarOfStorms, "Avatar of Storms", DeityType.Tharos)
            {
                Kind = PerkKind.Player,
                Category = PerkCategory.Combat,
                Description =
            ...
            // Tier 1 - Fledgling (0-499 prestige) - Foundation
            new(PerkIds.TharosStormCallers, "Storm Callers", DeityType.Tharos)
            {
                Kind = PerkKind.Religion,
                Category = PerkCategory.Combat,
                Description =
            ...
            // Tier 2 - Established (500-1999 prestige) - Coordination
            new(PerkIds.TharosLightningChain, "Lightning Chain", DeityType.Tharos)
            {
                Kind = PerkKind.Religion,
                Category = PerkCategory.Combat,
                Description =
            ...
            // Tier 3 - Renowned (2000-4999 prestige) - Elite Force
            new(PerkIds.TharosThunderstorm, "Thunderstorm", DeityType.Tharos)
            {
                Kind = PerkKind.Religion,
                Category = PerkCategory.Combat,
                Description =
            ...
            new(PerkIds.TharosEyeOfTheStorm, "Eye of the Storm", DeityType.Tharos)
            {
                Kind = PerkKind.Religion,
                Category = PerkCategory.Combat,
                Description =
    ...
    private static List<Perk> GetGaiaPerks()
    {
        return new List<Perk>
        {
            ...
            // Tier 1 - Initiate (0-499 favor) - Foundation
            new(PerkIds.GaiaEarthenResilience, "Earthen Resilience", DeityType.Gaia)
            {
                Kind = PerkKind.Player,
                Category = PerkCategory.Defense,
                Description =
            ...
            // Tier 2 - Disciple (500-1999 favor) - Choose Your Path
            new(PerkIds.GaiaStoneForm, "Stone Form", DeityType.Gaia)
            {
                Kind = PerkKind.Player,
                Category = PerkCategory.Defense,
                Description =
            ...
            new(PerkIds.GaiaNaturesBlessing, "Nature's Blessing", DeityType.Gaia)
            {
                Kind = PerkKind.Player,
                Category = PerkCategory.Utility,
                Description =
            ...
            // Tier 3 - Zealot (2000-4999 favor) - Specialization
            new(PerkIds.GaiaMountainGuard, "Mountain Guard", DeityType.Gaia)
            {
                Kind = PerkKind.Player,
                Category = PerkCategory.Defense,
                Description =
            ...
            new(PerkIds.GaiaLifebloom, "Lifebloom", DeityType.Gaia)
            {
                Kind = PerkKind.Player,
                Category = PerkCategory.Utility,
                Description =
            ...
            // Tier 4 - Champion (5000-9999 favor) - Capstone (requires both paths)
            new(PerkIds.GaiaAvatarOfEarth, "Avatar of Earth", DeityType.Gaia)
            {
                Kind = PerkKind.Player,
                Category = PerkCategory.Defense,
                Description =
            ...
            // Tier 1 - Fledgling (0-499 prestige) - Foundation
            new(PerkIds.GaiaEarthwardens, "Earthwardens", DeityType.Gaia)
            {
                Kind = PerkKind.Religion,
                Category = PerkCategory.Defense,
                Description =
            ...
            // Tier 2 - Established (500-1999 prestige) - Coordination
            new(PerkIds.GaiaLivingFortress, "Living Fortress", DeityType.Gaia)
            {
                Kind = PerkKind.Religion,
                Category = PerkCategory.Defense,
                Description =
            ...
            // Tier 3 - Renowned (2000-4999 prestige) - Elite Force
            new(PerkIds.GaiaNaturesWrath, "Nature's Wrath", DeityType.Gaia)
            {
                Kind = PerkKind.Religion,
                Category = PerkCategory.Combat,
                Description =
            ...
            new(PerkIds.GaiaWorldTree, "World Tree", DeityType.Gaia)
            {
                Kind = PerkKind.Religion,
                Category = PerkCategory.Defense,
                Description =
    ...
    private static List<Perk> GetVexPerks()
    {
        return new List<Perk>
        {
            ...
            // Tier 1 - Initiate (0-499 favor) - Foundation
            new(PerkIds.VexMaddeningWhispers, "Maddening Whispers", DeityType.Vex)
            {
                Kind = PerkKind.Player,
                Category = PerkCategory.Combat,
                Description =
            ...
            // Tier 2 - Disciple (500-1999 favor) - Choose Your Path
            new(PerkIds.VexChaoticFury, "Chaotic Fury", DeityType.Vex)
            {
                Kind = PerkKind.Player,
                Category = PerkCategory.Combat,
                Description =
            ...
            new(PerkIds.VexDeliriumShield, "Delirium Shield", DeityType.Vex)
            {
                Kind = PerkKind.Player,
                Category = PerkCategory.Defense,
                Description =
            ...
            // Tier 3 - Zealot (2000-4999 favor) - Specialization
            new(PerkIds.VexPandemonium, "Pandemonium", DeityType.Vex)
            {
                Kind = PerkKind.Player,
                Category = PerkCategory.Combat,
                Description =
            ...
            new(PerkIds.VexMindFortress, "Mind Fortress", DeityType.Vex)
            {
                Kind = PerkKind.Player,
                Category = PerkCategory.Defense,
                Description =
            ...
            // Tier 4 - Champion (5000-9999 favor) - Capstone (requires both paths)
            new(PerkIds.VexAvatarOfMadness, "Avatar of Madness", DeityType.Vex)
            {
                Kind = PerkKind.Player,
                Category = PerkCategory.Combat,
                Description =
            ...
            // Tier 1 - Fledgling (0-499 prestige) - Foundation
            new(PerkIds.VexCultOfChaos, "Cult of Chaos", DeityType.Vex)
            {
                Kind = PerkKind.Religion,
                Category = PerkCategory.Combat,
                Description =
            ...
            // Tier 2 - Established (500-1999 prestige) - Coordination
            new(PerkIds.VexSharedMadness, "Shared Madness", DeityType.Vex)
            {
                Kind = PerkKind.Religion,
                Category = PerkCategory.Combat,
                Description =
            ...
            // Tier 3 - Renowned (2000-4999 prestige) - Elite Force
            new(PerkIds.VexInsanityAura, "Insanity Aura", DeityType.Vex)
            {
                Kind = PerkKind.Religion,
                Category = PerkCategory.Combat,
                Description =
            ...
            new(PerkIds.VexRealmOfMadness, "Realm of Madness", DeityType.Vex)
            {
                Kind = PerkKind.Religion,
                Category = PerkCategory.Combat,
                Description =
