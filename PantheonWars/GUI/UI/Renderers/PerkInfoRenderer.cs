...
namespace PantheonWars.GUI.UI.Renderers
{
    ...
    internal static class PerkInfoRenderer
    {
        ...
        private static readonly Vector4 ColorWhite = new Vector4(0.9f, 0.9f, 0.9f, 1.0f);
        private static readonly Vector4 ColorGrey = new Vector4(0.573f, 0.502f, 0.416f, 1.0f);      // #92806a
        private static readonly Vector4 ColorGreen = new Vector4(0.478f, 0.776f, 0.184f, 1.0f);     // #7ac62f lime
        private static readonly Vector4 ColorRed = new Vector4(0.749f, 0.400f, 0.247f, 1.0f);       // #bf663f
        private static readonly Vector4 ColorDarkBrown = new Vector4(0.16f, 0.12f, 0.09f, 0.9f);    // #2a1f16
            ...
            float x, float y, float width, float height)
        {
            ...
            // Status badge
            string statusText = selectedState.VisualState switch
            {
        ...
        private static string FormatStatModifier(string statName, float value)
        {
            ...
            string displayName = statName switch
            {
