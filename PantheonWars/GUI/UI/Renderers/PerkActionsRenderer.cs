...
namespace PantheonWars.GUI.UI.Renderers
{
    ...
    /// </summary>
    internal static class PerkActionsRenderer
    {
        // Color constants
        private static readonly Vector4 ColorButtonNormal = new Vector4(0.24f, 0.18f, 0.13f, 1.0f);    // #3d2e20
        private static readonly Vector4 ColorButtonHover = new Vector4(0.35f, 0.26f, 0.19f, 1.0f);     // Lighter brown
        private static readonly Vector4 ColorButtonActive = new Vector4(0.478f, 0.776f, 0.184f, 1.0f); // #7ac62f lime
        private static readonly Vector4 ColorButtonDisabled = new Vector4(0.2f, 0.15f, 0.11f, 0.6f);   // Dark, semi-transparent
        private static readonly Vector4 ColorTextNormal = new Vector4(0.9f, 0.9f, 0.9f, 1.0f);
        private static readonly Vector4 ColorTextDisabled = new Vector4(0.5f, 0.5f, 0.5f, 1.0f);
        private static readonly Vector4 ColorGold = new Vector4(0.996f, 0.682f, 0.204f, 1.0f);         // #feae34
        ...
        public static float Draw(
            ...
            System.Action? onCloseClicked)
        {
            // Close button is always visible and enabled
            float closeButtonX = x - ButtonWidth;
            ...
            {
                float unlockButtonX = closeButtonX - ButtonWidth - ButtonSpacing;
                bool canUnlock = selectedState.CanUnlock && !selectedState.IsUnlocked;

                string buttonText = selectedState.IsUnlocked ? "Unlocked" : "Unlock";
                var buttonColor = canUnlock ? ColorButtonActive : ColorButtonDisabled;
                var textColor = canUnlock ? ColorTextNormal : ColorTextDisabled;

                bool clicked = DrawButton(buttonText, unlockButtonX, y, ButtonWidth, ButtonHeight,
            ...
            System.Action? onClick)
        {
            ...
            bool isHovering = enabled && IsMouseInRect(x, y, width, height);
