...
namespace PantheonWars.GUI.UI
{
    ...
    internal static class PerkUIRenderer
    {
            ...
            System.Action? onCloseClicked)
        {
            ...
            float usedHeight = ReligionHeaderRenderer.Draw(
                manager, api,
            ...
            float treeHeight = windowHeight - currentY - infoPanelHeight - padding * 2;
            ...
            float buttonY = windowHeight - actionButtonHeight - actionButtonPadding;
            float buttonX = windowWidth - actionButtonPadding;
