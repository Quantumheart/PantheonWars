...
namespace PantheonWars.GUI
{
    ...
    public class PerkDialogManager
    {
        ...
        public Dictionary<string, PerkNodeState> PlayerPerkStates { get; private set; } = new();
        public Dictionary<string, PerkNodeState> ReligionPerkStates { get; private set; } = new();
        ...
        {
            if (PlayerPerkStates.TryGetValue(perkId, out var playerState))
            {
                return playerState;
            }

            if (ReligionPerkStates.TryGetValue(perkId, out var religionState))
            {
