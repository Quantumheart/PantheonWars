...
public class ReligionActionRequestPacket
{
    ...
    [ProtoMember(1)] public string Action { get; set; } = string.Empty; // "join", "leave", "kick", "invite"

    [ProtoMember(2)] public string ReligionUID { get; set; } = string.Empty;

    [ProtoMember(3)] public string TargetPlayerUID { get; set; } = string.Empty; // For kick/invite actions
}